...
brew 'akamai'                                  # CLI toolkit for working with Akamai's APIs
...
brew 'xq'                                      # Command-line XML and HTML beautifier and content extractor
...
brew 'cmus'                                    # Music player with an ncurses based interface
...
brew 'nb'                                      # Command-line and local web note-taking, bookmarking, and archiving
brew 'jupyterlab'                              # Interactive environments for writing and running code


# Other Productivity Apps
#type name                                     description
cask 'textsniper'                              # Extract text from images and other digital documents
cask 'maccy'                                   # Clipboard manager
cask 'keyboard-maestro'                        # Automation software
cask 'hazel'                                   # Automated organisation
cask 'itsycal'                                 # Menu bar calendar
cask 'bartender'                               # Menu bar icon organiser


# CLI Development Suite
#type name                                     description
...
brew 'eg-examples'                             # Useful examples at the command-line
...
brew 'ansiweather'                             # Weather in your terminal, with ANSI colors and Unicode symbols
brew 'countdown'                               # Terminal countdown timer
brew 'wtfutil'                                 # Personal information dashboard for your terminal
...
brew 'watson'                                  # Command-line tool to track (your) time
...
cask 'bruno'                                   # HTTP API testing app
cask 'sourcetree'                              # Git visual client
cask 'visual-studio-code'                      # Code editor
cask 'wezterm'                                 # Even better terminal emulator
cask 'kitty'
...
brew 'python-lxml'                             # Pythonic binding for the libxml2 and libxslt libraries
...
brew 'bash-completion', link: false            # Programmable completion for Bash 3.2
brew 'pssh'                                    # Parallel versions of OpenSSH and related tools
cask 'powershell'                              # Command-line shell and scripting language
brew 'asdf'                                    # Extendable version manager with support for Ruby, Node.js, Erlang & mo
brew 'coreutils'                               # GNU File, Shell, and Text utilities
cask 'openlens'                                # Open source build of Lens Kubernetes IDE
brew 'mongosh'                                 # MongoDB Shell to connect, configure, query, and work with your MongoDB
...
brew 'sfk'                                     # Command-line tools collection
brew 'lnav'                                    # Curses-based tool for viewing and analyzing log files

# Development Utils
#type name                                     description
cask 'rsyncosx'                                # GUI for rsync
cask 'sourcetree'                              # Graphical client for Git version control
cask 'forklift'                                # Finder replacement and FTP, SFTP, WebDAV and Amazon s3 client
...
brew 'jesseduffield/lazygit/lazygit'           # A simple terminal UI for git commands, written in Go
...
brew 'ttygif'                                  # Converts a ttyrec file into gif files
...
brew 'duck'                                    # Command-line interface for Cyberduck (a multi-protocol file transfer t
...
brew 'diceware'                                # Passphrases to remember
cask 'gpg-suite-no-mail'                       # Tools to protect your files
...
brew 'envchain'                                # Secure your credentials in environment variables
...
brew 'asciidoc'                                # Formatter/translator for text files to numerous formats
brew 'docbook'                                 # Standard XML representation system for technical documents
...
brew 'snownews'                                # Text mode RSS newsreader
...
#type name                                     description
cask '1password-cli'                           # Password manager (proprietary)
...
cask 'vivaldi'                                 # Web browser with built-in email client focusing on customization and c
...
# Mac OS Utility Apps
# type  name                                     description
cask   'joplin'                                  # Note taking and to-do application with synchronisation capabilities
brew   'joplin-cli'                              # Note taking and to-do application with synchronization capabilities
...
brew   'marp-cli'                                # Easily convert Marp Markdown files into static HTML/CSS, PDF, PPT and
